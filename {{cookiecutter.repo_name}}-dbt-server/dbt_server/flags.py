...
CELERY_BROKER_URL = InMemoryFlag("CELERY_BROKER_URL", "redis://10.105.59.139:6379/0")
# Celery task backend url for dbt server to get task results.
CELERY_BACKEND_URL = InMemoryFlag("CELERY_BACKEND_URL", "redis://10.105.59.139:6379/0")
